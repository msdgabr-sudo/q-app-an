...
assert(bootstrap.includes('online-adhan-policy.js?v=20260821-code3-online-adhan1'),'online Adhan policy loader version missing');
assert(bootstrap.includes('schedule-sync.js?v=20260821-code3-online-adhan1'),'return-confirmed prayer sync loader version missing');
const sw=read('service-worker.js');
assert(sw.includes("VERSION='qiblaastro-3.1.0-code3-online-adhan-exp1'"),'experimental versioned service-worker cache missing');
assert(sw.includes("BRIDGE_RELEASE='online-visible-native-notice-20260821-exp1'"),'online Adhan bridge release marker missing');
